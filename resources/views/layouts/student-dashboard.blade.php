            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-small-cap"><span class="hide-menu">Information</span></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{url('student.student-view-teaching-material')}}"
                                aria-expanded="false"><i data-feather="list" class="feather-icon"></i><span
                                    class="hide-menu">View</span></a></li>
